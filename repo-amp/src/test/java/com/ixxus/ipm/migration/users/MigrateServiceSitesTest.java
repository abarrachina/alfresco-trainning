...
public class MigrateServiceSitesTest {
    ...
    private Set<String> siteNames = new HashSet<String>(); //Sites where newuser is an authority,
	...
	public void migrateToAnExistingUserTest() {
		...
		addSiteToNewUser();
		migrateService.migrateSites(olduser, newuser);
